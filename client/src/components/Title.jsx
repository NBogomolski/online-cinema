  ...
  return (
    <div className="w-full flex flex-col justify-center items-center">
      ...
      <div className="w-9/12 flex flex-col justify-center items-center bg-slate-300 max-h-max">
        <h1 className="text-5xl py-6 text-center flex flex-row">
          ...
          <div className="ml-2 cursor-pointer" onClick={() => {
            ...
            {isInWatchlist ?
            <svg xlinkTitle="In watchlist" xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512">
        ...
        <div className="flex flex-row h-96 w-fit justify-center align-center my-4 flex-wrap max-h-fit">
          <img
            ...
            src={movieCustomInfo?.primaryImage?.url}
            alt="Failed to load"
            onError={(e) => {
        ...
        <div className="text-3xl pb-4">Main cast</div>
        <div className="w-4/6 flex flex-row">
          ...
          <div className="ml-6 flex flex-row w-auto justify-between items-center flex-grow">
            {movieCustomInfo?.principalCast?.at(0)?.credits.map((actor) => {
              return (
                <div className="flex flex-col" key={actor.name.id}>
                  <img
                    className="h-36 w-28 cursor-pointer"
                  ...
                  />
                  <p className="whitespace-wrap overflow-auto text-clip text-center">
